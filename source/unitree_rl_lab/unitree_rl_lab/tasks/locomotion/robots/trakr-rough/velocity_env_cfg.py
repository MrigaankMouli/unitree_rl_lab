...
from unitree_rl_lab.assets.robots.trakr import TRAKR_CFG as ROBOT_CFG
...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "hf_pyramid_slope": terrain_gen.HfPyramidSlopedTerrainCfg(
            proportion=0.1, slope_range=(0.5, 1.0), platform_width=2.0, border_width=0.25
        ),
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    # robots
    #Changed the prim path to match the trakr_imu.usd file
    robot: ArticulationCfg = ROBOT_CFG.replace(prim_path="{ENV_REGEX_NS}/trakr")
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformLevelVelocityCommandCfg(
        ...
        ranges=mdp.UniformLevelVelocityCommandCfg.Ranges(
            lin_vel_x=(-0.5, 0.5), lin_vel_y=(-0.5, 0.5), ang_vel_z=(-1, 1)
        ),
        limit_ranges=mdp.UniformLevelVelocityCommandCfg.Ranges(
            lin_vel_x=(-2.0, 2.0), lin_vel_y=(-0.8, 0.8), ang_vel_z=(-1.0, 1.0)
        ),
    )
